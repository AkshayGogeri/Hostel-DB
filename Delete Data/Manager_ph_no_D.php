...
<br/><br/><h1>Manager Phone Number Table</h1>
<br/>

 <input name="id" type="text" id="id" placeholder="Enter the Manager ID" class="form-control"> 
<br/>
 <input name="pn" type="text" id="pn" placeholder="Enter the Manager Phone number to be deleted" class="form-control"> 
 <br/>
